...
function Header() {
  return (
    <nav className='flex justify-between p-5 text-2xl w-full bg-slate-800 text-white fixed w-full '>
      ...
      <ul className='flex'>
        <li className='px-10'><Link to={'/wishlist'}> <i class="fa-regular fa-heart text-red-500 "></i> Whishlist <span className='p-1 ms-1 bg-zinc-600 rounded-full ms-1 '>10</span> </Link></li>
